...
- (instancetype)initWithFrame:(CGRect)frame
{
    if (self = [super initWithFrame:frame]) {
        ...
        UILabel *vNumLab = [[UILabel alloc] initWithFrame:CGRectMake(0, lab.frame.size.height, 60, 45)];
        ...
        topCollectionView = [[TopCollectionView alloc] initWithFrame:CGRectMake(vNumLab.frame.size.width, lab.frame.size.height, frame.size.width-vNumLab.frame.size.width, 45) collectionViewLayout:collectionViewFlowLayout];
